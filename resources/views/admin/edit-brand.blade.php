    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="background-color: #f3f9fc;">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2 style="font-weight: bold; font-size: 1.5rem; text-align: left;">Edit Brand</h2>
                ...
                <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row" style="margin-top: 15px;">
                        ...
                        <div class="col-sm-9">
                            <div id="upload-area">
                                <label for="images" id="upload-label" style="color: black; cursor: pointer; display: flex; justify-content: center; align-items: center; text-align: center; padding: 30px; border: 1px dashed #ccc; border-radius: 5px; height: 250px;">
                                    @if($brand->brand_image)
                                        <img src="{{ asset('storage/' . $brand->brand_image) }}" alt="{{ $brand->name }}" style="max-width: 100%; max-height: 100%;"/>
                                    @else
                                        <div>
                            ...
                            <input type="file" class="form-control-file" id="images" name="brand_image" style="display: none;" onchange="displayImage(this)">
                        </div>
                    </div>
