                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.products.index') }}" method="GET"
                            class="mb-3 d-flex align-items-center" style="justify-content: space-between;">
                            <div class="d-flex align-items-center" style="flex-grow: 1;">
                                <input type="text" name="search" class="form-control" placeholder="Search products..."
                                    value="{{ request('search') }}" style="margin-right: 10px; max-width: 250px;">
                                <button type="submit" class="btn btn-secondary" style="width: 100px;">Search</button>
                            </div>
                            <a href="{{ route('admin.products.create') }}" class="btn"
                                style="border: 1px solid black; color: blue; margin-left: 10px;">+ Add New</a>
                        </form>
